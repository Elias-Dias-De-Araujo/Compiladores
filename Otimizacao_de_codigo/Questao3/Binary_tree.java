...
public class Binary_tree {
    public Node root;
    private Node lastNodePattern = null;
    ...
    public void printCode(ArrayList<String> newSelectedPatterns) {
        for (int i = 0; i < newSelectedPatterns.size(); i++) {
            String[] splitedP = newSelectedPatterns.get(i).split(" ");
            if (!splitedP[0].equalsIgnoreCase("TEMP")) {
                findLastPatternOcurrence(root, newSelectedPatterns.get(i));
                String lineCode = i + 1 + " " + splitedP[0] + " ";

                if (splitedP[0].equalsIgnoreCase("ADD")) {
                    ...
                    if (splitedPAuxLeftPattern[0].equalsIgnoreCase("TEMP")
                            && splitedPAuxRightPattern[0].equalsIgnoreCase("TEMP")) {
                        if (splitedPAuxLeft[0].equalsIgnoreCase("FP") && splitedPAuxRight[0].equalsIgnoreCase("FP")) {
                            lineCode += currentRegister + " <- fp + fp";
                        } else if (splitedPAuxLeft[0].equalsIgnoreCase("FP")) {
                            lineCode += currentRegister + " <- fp + " + splitedPAuxRight[1];
                        } else if (splitedPAuxRight[0].equalsIgnoreCase("FP")) {
                            lineCode += currentRegister + " <- fp + " + splitedPAuxLeft[1];
                        } else {
                            lineCode += currentRegister + " <- r" + splitedPAuxLeft[1] + " + r"
                                    + splitedPAuxRight[1];
                        }
                    } else {
                        lineCode += patternsSimple("+");
                    }
                } else if (splitedP[0].equalsIgnoreCase("MUL")) {
                    String[] splitedPAuxLeft = lastNodePattern.getLeft().getValue().split(" ");
                    String[] splitedPAuxRight = lastNodePattern.getRight().getValue().split(" ");
                    String[] splitedPAuxLeftPattern = lastNodePattern.getLeft().getPattern().split(" ");
                    String[] splitedPAuxRightPattern = lastNodePattern.getRight().getPattern().split(" ");
                ...
                } else if (splitedP[0].equalsIgnoreCase("SUB")) {
                    String[] splitedPAuxLeft = lastNodePattern.getLeft().getValue().split(" ");
                    String[] splitedPAuxRight = lastNodePattern.getRight().getValue().split(" ");
                    String[] splitedPAuxLeftPattern = lastNodePattern.getLeft().getPattern().split(" ");
                    String[] splitedPAuxRightPattern = lastNodePattern.getRight().getPattern().split(" ");
                ...
                } else if (splitedP[0].equalsIgnoreCase("DIV")) {
                    String[] splitedPAuxLeft = lastNodePattern.getLeft().getValue().split(" ");
                    String[] splitedPAuxRight = lastNodePattern.getRight().getValue().split(" ");
                    String[] splitedPAuxLeftPattern = lastNodePattern.getLeft().getPattern().split(" ");
                    String[] splitedPAuxRightPattern = lastNodePattern.getRight().getPattern().split(" ");
                ...
                } else if (splitedP[0].equalsIgnoreCase("ADDI")) {
                    lineCode += currentRegister + " <- ";
                    String[] splitedPAux;
                    if (lastNodePattern.getLeft() != null && lastNodePattern.getRight() != null) {
                        String[] splitedPAuxLeft = lastNodePattern.getLeft().getValue().split(" ");
                        String[] splitedPAuxRight = lastNodePattern.getRight().getValue().split(" ");
                        String[] splitedPAuxLeftPattern = lastNodePattern.getLeft().getPattern().split(" ");
                        String[] splitedPAuxRightPattern = lastNodePattern.getRight().getPattern().split(" ");
                        ...
                        // cai no caso que é apenas const
                        splitedPAux = lastNodePattern.getValue().split(" ");
                        lineCode += "r0" + " + " + splitedPAux[1];
                    }
                } else if (splitedP[0].equalsIgnoreCase("SUBI")) {
                    lineCode += currentRegister + " <- ";
                    String[] splitedPAuxLeft = lastNodePattern.getLeft().getValue().split(" ");
                    String[] splitedPAuxRight = lastNodePattern.getRight().getValue().split(" ");
                    String[] splitedPAuxLeftPattern = lastNodePattern.getLeft().getPattern().split(" ");
    ...
    public String patternsSimple(String symbol) {
        String lineCode = currentRegister + " <- ";
        String[] splitedPAuxLeft = lastNodePattern.getLeft().getPattern().split(" ");
        String[] splitedPAuxRight = lastNodePattern.getRight().getPattern().split(" ");
        if (splitedPAuxLeft[0].equalsIgnoreCase("TEMP")) {
            if (lastNodePattern.getLeft().getValue().equalsIgnoreCase("FP")) {
                lineCode += "fp " + symbol + " r2";
            } else {
                splitedPAuxLeft = lastNodePattern.getLeft().getValue().split(" ");
                lineCode += "r" + splitedPAuxLeft[1] + " " + symbol + " r2";
            }
        } else if (splitedPAuxRight[0].equalsIgnoreCase("TEMP")) {
            if (lastNodePattern.getRight().getValue().equalsIgnoreCase("FP")) {
                lineCode += "r1 " + symbol + " fp";
            } else {
                splitedPAuxRight = lastNodePattern.getRight().getValue().split(" ");
                lineCode += "r1 " + symbol + " " + "r" + splitedPAuxRight[1];

            }
        } else {
            lineCode += "r1 " + symbol + " r2";
        }
        return lineCode;
    }

    public void printCostAndPatterns(ArrayList<String> newSelectedPatterns) {
    ...
    public void findLastPatternOcurrence(Node current, String pattern) {
        if (current != null) {
            findLastPatternOcurrence(current.getLeft(), pattern);
            findLastPatternOcurrence(current.getRight(), pattern);
            if (current.getPattern().equalsIgnoreCase(pattern)) {
                lastNodePattern = current;
                if (current.getParent() != null) {
                    ...
                    if (current.getLeft() != null) {
                        if (current.getLeft().getPattern() == pattern) {
                            currentRegister = "r1";
                        }
                    } else if (current.getRight() != null) {
                        if (current.getRight().getPattern() == pattern) {
                            currentRegister = "r2";
                        }
                    } else {
                        currentRegister = "r1";
